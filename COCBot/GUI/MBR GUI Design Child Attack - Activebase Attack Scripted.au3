...
Func CreateAttackSearchActiveBaseScripted()
	...
	Local $x = 25, $y = 20
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Attack Scripted", "Group_01",  -1), $x - 20, $y - 20, 270, $g_iSizeHGrpTab4 + $l_suma)
	...
	$y += 15
		...
		$y += 25	
		$g_hLblNotesScriptAB =  GUICtrlCreateLabel("", $x, $y + 5, 200, 180 + $l_suma)
		$y += $l_suma
	...
	; _GUICreate("", ancho, alto,horizontal, vertical, $WS_POPUP, $WS_EX_MDICHILD, $hGUI_Main)
...
_GUIScrollBars_Generate($g_hGUI_ACTIVEBASE_ATTACK_SCRIPTED, $x, $y + $l_suma + $l_suma)
