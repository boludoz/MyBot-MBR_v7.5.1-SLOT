...
; updated 2018
Global $MyTroopsCost[20][9] = _
		[[25, 40, 60, 100, 150, 200, 250, 300], _ 			        ; Barbarian
		[50, 80, 120, 200, 300, 400, 500, 600], _ 			        ; Archer
		[250, 750, 1250, 1750, 2250, 3000, 3500, 4000, 4500], _ 	    ; Giant
		[25, 40, 60, 80, 100, 150, 200], _ 				 	        ; Goblin
		[1000, 1500, 2000, 2500, 3000, 3500, 4000, 4500], _          ; WallBreaker
		[2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500], _ 	        ; Balloon
		[1500, 2000, 2500, 3000, 3500, 4000, 4500, 5000, 5500], _    ; Wizard
		[5000, 6000, 8000, 10000, 15000], _					        ; Healer
		[18000, 20000, 22000, 24000, 26000, 28000, 30000], _         ; Dragon
		[21000, 24000, 27000, 30000, 33000, 35000, 37000, 39000], _  ; Pekka
		[15000, 16000, 17000, 18000, 19000, 20000], _ 			    ; BabyDragon
		[4200, 4800, 5200, 5600, 6000, 6400], _  			        ; Miner
		[36000, 40000, 44000], _  		                 	        ; ElectroDragon
		[6, 7, 8, 9, 10, 11, 12, 13], _ 							    ; Minion
		[40, 45, 52, 58, 65, 90, 115, 140], _					    ; HogRider
		[70, 100, 130, 160, 190, 220, 250], _ 				 	    ; Valkyrie
		[450, 525, 600, 675, 750, 825, 900, 975], _ 				    ; Golem
		[250, 350, 450, 550], _ 								 	    ; Witch
		[390, 450, 510, 570, 630], _  							    ; Lavahound
		[130, 150, 170, 190]] 									    ; Bowler
